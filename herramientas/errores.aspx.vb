...
Partial Class herramientas_errores
    ...
    Protected Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        ...
        Try
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Errores", "Solicitó listado desde la fecha: " & txt_fecha_inicio.Text & " a la: " & txt_fecha_final.Text & ".")
    ...
    Sub cargar_GV()
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=kernel_facturacion")
                ...
                memComando.CommandText = "SELECT * FROM error_program WHERE fecha BETWEEN @txt_fecha_inicio AND @txt_fecha_final AND id_usuario=" & tabla_usuario.Rows(0)("Id") & " AND id_empresa=" & tabla_empresa.Rows(0)("Id") & " ORDER BY id DESC;"
    ...
    Protected Sub img_exportar_excel_Click(sender As Object, e As EventArgs) Handles img_exportar_excel.Click
        ...
        Try
            ...
            'Crear Excel
            Dim nombre As String = funciones_globales.crear_excel("Errores", gridview_consulta, tabla_usuario.Rows(0)("Id"))
    ...
    Protected Sub img_exportar_txt_Click(sender As Object, e As EventArgs) Handles img_exportar_txt.Click
        ...
        Try
            ...
            'Crear Excel
            Dim nombre As String = funciones_globales.crear_txt("Errores", gridview_consulta, tabla_usuario.Rows(0)("Id"))
