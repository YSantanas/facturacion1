<%@ Page Language="VB" AutoEventWireup="false" CodeFile="registros_usuarios.aspx.vb" Inherits="herramientas_registros_usuarios" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Registros de Usuarios</h5>
        ...
        <div class="panel-container">
            ...
            <div class="panel-left">
                ...
                <div class="input-group input-group-sm mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            ...
                            <asp:LinkButton ID="Lkb_reset" runat="server" CssClass="bi bi-arrow-clockwise text-primary" Font-Size="13" ToolTip="Refrescar" TabIndex ="-1" Visible="true" OnClientClick ="mostrar_trabajando('Actualizando usuarios, por favor espere.');"></asp:LinkButton>&nbsp;&nbsp;Usuario:
                        
                        </span>
                    </div>
                    <asp:DropDownList ID="DDL_usuarios" runat="server" class="form-control"></asp:DropDownList>
                </div>
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <asp:TextBox ID="txt_buscar" runat="server" class="form-control" placeholder="Palabra a Buscar"></asp:TextBox>
                </div>
                <br />
      
                <div class="container-fluid" style="text-align:center">
                    <asp:Button ID="btn_consultar" runat="server" CssClass="btn btn-outline-primary btn-sm" Text="Ver Registros de Usuario" />
                </div>
            ...
            <ContentTemplate>
                ...
                cssclass="table table-condensed" Font-Size="11px" Width="100%" ToolTip="Registros de Usuarios" EmptyDataText="No hay resultados."
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="fecha" HeaderText="Fecha" HeaderStyle-Width="75"
                    ...
                    <ItemStyle HorizontalAlign="Left" Width="75"></ItemStyle>
                     ...
                     <asp:BoundField DataField="hora" HeaderText="Hora" HeaderStyle-Width="75"
                        SortExpression="hora" ReadOnly="True">
                    <HeaderStyle CssClass="gvHeaderleft"  />
                    <ItemStyle HorizontalAlign="Left" Width="75"></ItemStyle>
                    </asp:BoundField>
                    
                   <asp:BoundField DataField="nombre_usuario" HeaderText="Nombre" HeaderStyle-Width="180"
                        SortExpression="nombre_usuario" ReadOnly="True" ItemStyle-HorizontalAlign="left">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" Width ="180"></ItemStyle>
                    </asp:BoundField>

                    <asp:BoundField DataField="modulo" HeaderText="Referencia" HeaderStyle-Width="100"
                        SortExpression="modulo" ReadOnly="True" ItemStyle-HorizontalAlign="left">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" Width ="100"></ItemStyle>
                    </asp:BoundField>
                   
                    <asp:BoundField DataField="descripcion" HeaderText="Descripción" HeaderStyle-Width="290"
                        SortExpression="descripcion" ReadOnly="True" ItemStyle-HorizontalAlign="left">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" Width ="290"></ItemStyle>
                    </asp:BoundField>
