<%@ Page Language="VB" AutoEventWireup="false" CodeFile="consultas.aspx.vb" Inherits="presupuestos_consultas" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn_consultar").on('click', function (e) {
                ...
                //Mensaje al usuario
                mostrar_trabajando('Consultando Presupuestos, por favor espere.');
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <h5>Consultas de Presupuestos</h5>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td width="150" align="center"><small>Nº Presupuesto</small></td>
            ...
            <tr>
                ...
                <td align="right"><asp:TextBox ID="txt_n_presupuesto" runat="server" CssClass="form-control input-sm" MaxLength="150" width="99%" Style="text-transform: uppercase"></asp:TextBox></td>
       ...
       <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div id="ver" style="position:fixed;top:0px;background-color:#cce5ff;color:#333333;font-weight:700; width:100%;display:none;">
            ...
            <tr>                 
                ...
                <td width="100" align="center"><small>N.I.F.</small></td>
                <td width="250" align="center"><small>Nº Presupuesto</small></td>
                <td width="70" align="center"><small>Total</small></td>
                <td width="50" align="center"><small>Linea</small></td>                                       
            ...
            cssclass="table table-condensed" Font-Size="11px" Width="100%" ToolTip="Consulta de presupuestos" EmptyDataText="No hay resultados."
            CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="n_presupuesto,fecha_creacion,hora_creacion,fecha,cod_cliente,cliente,nif,total,linea,cod_articulo,denominacion" 
            ...
            <ItemTemplate>
                ...
                <asp:LinkButton ID ="lk_articulo" runat ="server" 
                    ...
                    Font-Size="25px"
                    ToolTip ="Ir a Presupuestos" TabIndex="-1" 
                    CommandName="ver_presupuesto"
                    CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" ForeColor="#dc3545" />
            </ItemTemplate>
            ...
            <asp:BoundField DataField="n_presupuesto" HeaderText="Nº Presupuesto" HeaderStyle-Width="100"
                SortExpression="n_presupuesto" ReadOnly="True" ItemStyle-HorizontalAlign="left">
            <HeaderStyle HorizontalAlign="Left" />
            <ItemStyle HorizontalAlign="Left" Width ="100"></ItemStyle>
            </asp:BoundField>
