<%@ Page Language="VB" AutoEventWireup="false" CodeFile="altas.aspx.vb" Inherits="presupuestos_altas" %>
...
<head runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //Tecla Abonar
            shortcut.add("Ctrl+F", function () { $("#img_convertir_albaran").click(); });
            ...
            "table contextmenu directionality emoticons template textcolor paste fullpage textcolor colorpicker textpattern"
                ...
                style_formats: [{
                    title: 'Tamaño de párrafo grande',
                    selector: 'p',
                    styles: {
                    fontSize: '20px'
                    }
            ...
            $("#LB_imprimir").on('click', function (e) {
                ...
                //Mensaje al usuario
                mostrar_trabajando('Generando Presupuesto, por favor espere.');
            ...
            //-------------------------------------------------------------------------------------------------------------------
            //Control para crear albaran
            $('#img_convertir_albaran').on('click', function (e) {

                if ($("#txt_presupuesto").val() == '') {
                    //mensaje
                    error('No hay ningun presupuesto para convertir en albarán.')
                    return false;
                }

                if (parseFloat($("#lbl_total").text().replace("€", "")) < 0) {
                    //mensaje
                    error('No puedes convertir en albarán un presupuesto en negativo.')
                    return false;
                }
            ...
            $('#img_duplicar').on('click', function (e) {
                ...
                if ($("#txt_presupuesto").val() == '') {
                    //mensaje
                    error('No hay ningún Presupuesto a duplicar.')
                    return false;
                }
    ...
    <div class="container-fluid" style="position :absolute; top:0px;left:0px;right:0px;bottom:0px;z-index:1;">
        ...
        <tr>
            <td style="width: 400px;">
                <h5>Alta de Presupuestos</h5></td>
            <td></td>
            <td style="width: 40px;">
                <asp:ImageButton ID="img_nuevo" runat="server" ToolTip="Nuevo Presupuesto (Ctrl + A)" ImageUrl="~/imagenes/web/nuevo.png" Width="20" TabIndex="-1"/>
            </td>
            <td style="width: 40px;">
                <asp:ImageButton ID="img_duplicar" runat="server" ToolTip="Duplicar Presupuesto (Ctrl + E)" ImageUrl="~/imagenes/web/duplicar.png" Width="20" TabIndex="-1"/>
            </td>
            <td style="width: 40px;">
                <asp:ImageButton ID="img_convertir_albaran" runat="server" ToolTip="Convertir en Albarán (Ctrl + M)" ImageUrl="~/imagenes/web/convertir_albaran.png" Width="20" TabIndex="-1"/>
            </td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txt_denominacion" runat="server" CssClass="form-control input-sm textbox_denominacion_articulos" MaxLength="250" width="100%"></asp:TextBox></td>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:50%;">
                            ...
                            AutoGenerateColumns="false" runat="server" 
                            cssclass="table table-condensed" Font-Size="11px" ToolTip="Detalles del Total del Presupuesto" EmptyDataText="No hay detalles."
