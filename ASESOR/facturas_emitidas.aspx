...
<head runat="server">
    ...
    <style>
        ...
        .bordes_redondo {
            border-radius:10px;
            -webkit-box-shadow: 0px 0px 30px -6px rgba(0,0,0,0.95);
            -moz-box-shadow: 0px 0px 0px -6px rgba(0,0,0,0.95);
        ...
        .cambiar_primary:hover {
            box-shadow: 0px 0px 3px 3px rgba(0,123,255,0.5);
            -webkit-box-shadow: 0px 0px 3px 3px rgba(0,123,255,0.5);
            -moz-box-shadow: 0px 0px 3px 3px rgba(0,123,255,0.5);
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row justify-content-md-center">
            ...
            <asp:Literal ID="Lt_facturas_emitidas" runat="server" ></asp:Literal>
            ...
            <div class="modal-dialog">
	            ...
	            <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5"><asp:Label ID="lbl_titulo_descargar" runat="server" Text="..."></asp:Label></h1>
        ...
        <!-- Modal Agregar -->
        <div class="modal" id="modal_mostrar" tabindex="-1" role="dialog" data-bs-backdrop="static" >
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <asp:TemplateField HeaderText ="Descargar" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:CheckBox ID="chk_marcar" runat="server" Checked ="true" />
                        </ItemTemplate>
    ...
    <div id="partes_hidden" style="visibility:hidden; display:none;">
        txt_bbdd:<asp:TextBox ID="txt_bbdd" runat="server" Width="400"></asp:TextBox><br />
    </div>
