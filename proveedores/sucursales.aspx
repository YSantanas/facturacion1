<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sucursales.aspx.vb" Inherits="proveedores_sucursales" %>
...
<head runat="server">
    ...
    $(document).ready(function () {
        ...
        $("#abrir_contactos").on('click', function (e) {
            ...
            $('#icontactos_', window.parent.document).attr('src', $('#icontactos_', window.parent.document).attr('src')); window.parent.abrir_ventana_relacional('contactos_', 'bi-columns', '1000', '600', 'proveedores/contactos.aspx|id_proveedor=' + $('#txt_cliente_modal').val() + '&id_sucursal_proveedor=' + $('#txt_sucursal_modal').val(), '2');
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Alta de Sucursales de Proveedores</h5>
        ...
        <div class="panel-container">
            ...
            <div class="container-fluid" style="text-align:center">
                ...
                CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="id,id_proveedor,fecha_creacion,hora_creacion,activo,denominacion,tipo_via,calle,numero,escalera,piso,puerta,cp,pais,provincia,localidad,observaciones,nombre_fiscal,nombre_tipo_via" 
