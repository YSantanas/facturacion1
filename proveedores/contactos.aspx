<%@ Page Language="VB" AutoEventWireup="false" CodeFile="contactos.aspx.vb" Inherits="proveedores_contactos" %>
    ...
    $(document).ready(function () {
        ...
        $("#btn_grabar").on('click', function () {
            ...
            if ($.trim($("#txt_cliente_modal").val()) == '') {
                error('El campo Proveedor no puede estar vacío.')
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Alta de Contactos de Proveedores</h5>
        ...
        <div class="panel-container">
            ...
            <div class="container-fluid" style="text-align:center">
                ...
                CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="id_proveedor,id_sucursal_proveedor,fecha_creacion,hora_creacion,cargo,nombre,primer_apellido,segundo_apellido,contacto,observaciones,nombre_fiscal" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="id_sucursal_proveedor" HeaderText="Código Sucursal" HeaderStyle-Width="90"
                        SortExpression="id_sucursal_proveedor" ReadOnly="True">
                    <HeaderStyle CssClass="gvHeaderleft"/>
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_cliente_modal" runat="server" class="form-control textbox_proveedor" placeholder="Escriba un Código de Proveedor, Nombre o *NIF"  maxlength="15" AutoPostBack="True"></asp:TextBox>
                        <div class="text-primary" style="position:absolute; top:35px;font-size: 12px;height:20px;">
