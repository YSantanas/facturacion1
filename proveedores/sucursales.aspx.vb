...
Partial Class proveedores_sucursales
    ...
    Sub leer_contactos(ByVal id_cliente As Integer, ByVal id_sucursal As Integer)
        ...
        Try
            ...
            For x = 0 To tabla_consulta.Rows.Count - 1
                ...
                'Cargo los detalles
                Dim lista As New System.Web.UI.WebControls.ListItem(tabla_consulta.Rows(x)("nombre").ToString & " " & tabla_consulta.Rows(x)("primer_apellido").ToString & " " & tabla_consulta.Rows(x)("segundo_apellido").ToString & " - " & tabla_consulta.Rows(x)("contacto").ToString, tabla_consulta.Rows(x)("id_proveedor").ToString & "|" & tabla_consulta.Rows(x)("id_sucursal").ToString)
    ...
    Protected Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        ...
        Try
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Sucursales", "Solicitó listado de sucursales del proveedor: " & txt_cliente.Text & ".(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Sub cargar_GV()
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa.Rows(0)("ruta_base_datos"))
                ...
                If txt_cliente.Text = "" Then
                    memComando.CommandText = "SELECT sucursales_proveedores.*,proveedores.nombre_fiscal, " &
                    ...
                    "WHERE sucursales_proveedores.id<>0 ORDER BY sucursales_proveedores.id_proveedor,sucursales_proveedores.id;"
                Else
                    If txt_sucursal.Text = "" Then
                        ...
                        "sucursales_proveedores ON proveedores.id=sucursales_proveedores.id_proveedor LEFT JOIN " &
                        "[kernel_facturacion].[dbo].tipo_vias ON sucursales_proveedores.tipo_via=tipo_vias.id " &
                        "WHERE sucursales_proveedores.id_proveedor=@id_proveedor AND sucursales_proveedores.id<>0 ORDER BY id_proveedor,id;"
                    ...
                    Else
                        ...
                        "sucursales_proveedores ON proveedores.id=sucursales_proveedores.id_proveedor LEFT JOIN " &
                        "[kernel_facturacion].[dbo].tipo_vias ON sucursales_proveedores.tipo_via=tipo_vias.id " &
                        "WHERE sucursales_proveedores.id_proveedor=@id_proveedor AND sucursales_proveedores.id=@id_sucursal AND sucursales_proveedores.id<>0 ORDER BY id_proveedor,id;"
                        memComando.Parameters.Add(New SqlParameter("id_proveedor", Data.SqlDbType.Int))
                        memComando.Parameters("id_proveedor").Value = txt_cliente.Text
    ...
    Private Sub txt_cliente_modal_TextChanged(sender As Object, e As EventArgs) Handles txt_cliente_modal.TextChanged
        ...
        Try
            ...
            If IsNumeric(txt_cliente_modal.Text) Then
                ...
                Dim tabla_consulta As DataTable = funciones_globales.obtener_datos("SELECT TOP (1) id FROM " & tabla_empresa.Rows(0)("ruta_base_datos") & ".[dbo].[sucursales_proveedores] WHERE id_proveedor=" & txt_cliente_modal.Text & " ORDER BY id DESC")
    ...
    Private Sub gridview_consulta_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridview_consulta.RowCommand
        ...
        Try
            ...
            If (e.CommandName = "borrar") Then
                ...
                LT_mensaje.Text = "¿Está seguro de eliminar la Sucursal: " & gridview_consulta.DataKeys(index).Item("id").ToString() & " del Proveedor: " & gridview_consulta.DataKeys(index).Item("nombre_fiscal").ToString() & "?"
            ...
            If (e.CommandName = "consultar") Then
                ...
                'leer contactos
                leer_contactos(gridview_consulta.DataKeys(index).Item("id_proveedor"), gridview_consulta.DataKeys(index).Item("id"))
                ...
                'Registro como bloque en local para el jquery
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType, "alerta_borrar", funciones_globales.modal_register("$('#txt_cliente_modal').attr('disabled',true);$('#txt_nombre_fiscal').attr('disabled',true);$('#txt_nombre_comercial').attr('disabled',true);$('#txt_sucursal_modal').attr('disabled',true);$('#txt_denominacion').attr('disabled',true);$('#txt_nif').attr('disabled',true);$('#DDL_tipo_via').attr('disabled',true);$('#txt_domicilio').attr('disabled',true);$('#txt_numero').attr('disabled',true);$('#txt_escalera').attr('disabled',true);$('#txt_piso').attr('disabled',true);$('#txt_puerta').attr('disabled',true);$('#DDL_provincia').attr('disabled',true);$('#DDL_localidad').attr('disabled',true);$('#DDL_pais').attr('disabled',true);$('#Lb_contactos').attr('disabled',true);$('#Lb_sucursales').attr('disabled',true);$('#CB_activo').attr('disabled',true);setTimeout(function () { $('#txt_denominacion').focus();$('#txt_denominacion').select();}, 100);$('#modal_agregar').modal('show');"), True)
    ...
    Private Sub Lkb_refrecar_contactos_Click(sender As Object, e As EventArgs) Handles Lkb_refrecar_contactos.Click
        ...
        Try
            ...
            'leer sucursales
            leer_contactos(gridview_consulta.DataKeys(txt_index.Text).Item("id_proveedor"), gridview_consulta.DataKeys(txt_index.Text).Item("id"))

            'Asignar
            txt_cliente_modal.Text = gridview_consulta.DataKeys(txt_index.Text).Item("id_proveedor")
    ...
    Protected Sub btn_eliminar_confirmar_Click(sender As Object, e As EventArgs) Handles btn_eliminar_confirmar.Click
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa.Rows(0)("ruta_base_datos"))
                ...
                memComando.CommandText = "DELETE FROM sucursales_proveedores WHERE id=" & gridview_consulta.DataKeys(txt_index.Text).Item("id") & " AND id_proveedor=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_proveedor") & ";"
                memComando.Connection = memConn
                memComando.ExecuteNonQuery()

                memComando.CommandText = "DELETE FROM contactos_proveedores WHERE id_proveedor=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_proveedor") & " AND id_sucursal_proveedor=" & gridview_consulta.DataKeys(txt_index.Text).Item("id") & ";"
                memComando.ExecuteNonQuery()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Sucursales", "Eliminó la Sucursal N: " & gridview_consulta.DataKeys(txt_index.Text).Item("id").ToString() & " del Proveedor: " & gridview_consulta.DataKeys(txt_index.Text).Item("nombre_fiscal").ToString() & ".(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Protected Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        Try
            ...
            Dim tabla_consulta As DataTable = funciones_globales.obtener_datos("SELECT TOP (1) id FROM " & tabla_empresa.Rows(0)("ruta_base_datos") & ".[dbo].[sucursales_proveedores] WHERE id_proveedor=" & txt_cliente_modal.Text & " AND id=" & txt_sucursal_modal.Text & " ORDER BY id DESC")
            If tabla_consulta.Rows.Count <> 0 Then
                'Registro como bloque en local para el jquery
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa(0)("ruta_base_datos"))
                ...
                'Agrego
                memComando.CommandText = "INSERT INTO sucursales_proveedores (id,id_proveedor,fecha_creacion,hora_creacion,activo,denominacion,tipo_via,calle,numero,escalera,piso,puerta,cp,pais,provincia,localidad,observaciones) VALUES " &
                            "(@id,@id_proveedor,@fecha_creacion,@hora_creacion,@activo,@denominacion,@tipo_via,@calle,@numero,@escalera,@piso,@puerta,@cp,@pais,@provincia,@localidad,@observaciones);"
                memComando.Parameters.Add("@id", Data.SqlDbType.Int).Value = txt_sucursal_modal.Text
                memComando.Parameters.Add("@id_proveedor", Data.SqlDbType.Int).Value = txt_cliente_modal.Text
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Sucursales", "Creó la Sucursal Nº: " & txt_sucursal_modal.Text & " del Proveedor: " & lbl_txt_cliente_modal.Text & ".(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Protected Sub btn_modificar_Click(sender As Object, e As EventArgs) Handles btn_modificar.Click
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa(0)("ruta_base_datos"))
                ...
                'Actualizo
                memComando.CommandText = "UPDATE sucursales_proveedores SET " &
                "activo=@activo, " &
                ...
                "WHERE id=" & gridview_consulta.DataKeys(txt_index.Text).Item("id") & " AND id_proveedor=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_proveedor") & ";"
                memComando.Parameters.Add("@activo", System.Data.SqlDbType.Bit).Value = CB_activo.Checked
                memComando.Parameters.Add("@denominacion", Data.SqlDbType.VarChar, 250).Value = txt_denominacion.Text.ToUpper
                memComando.Parameters.Add("@tipo_via", Data.SqlDbType.VarChar, 50).Value = DDL_tipo_via.SelectedValue
                memComando.Parameters.Add("@calle", Data.SqlDbType.VarChar, 70).Value = txt_domicilio.Text.ToUpper
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Sucursales", "Modificó la Sucursal: " & txt_sucursal_modal.Text & " del Proveedor: " & lbl_txt_cliente_modal.Text & ".(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
