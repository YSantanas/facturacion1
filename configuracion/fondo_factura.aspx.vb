...
Partial Class configuracion_fondo_factura
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Not System.IO.Directory.Exists("D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\") Then

                    'Creo el directorio
                    System.IO.Directory.CreateDirectory("D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\")

                    'Creo el pie del presupuesto
                    System.IO.File.Copy(Server.MapPath("..") & "\imagenes\factura\fondo_factura.png", "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\fondo_factura.png", True)
                    System.IO.File.Copy(Server.MapPath("..") & "\imagenes\factura\pie_factura.png", "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\pie_factura.png", True)
                ...
                If My.Computer.FileSystem.FileExists("D:/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/fondo_factura.png") = True Then
                    Image_factura.ImageUrl = "~/imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/fondo_factura.png?" + numero_aleatorio.Next(100, 999999999).ToString()
                    Image_factura.DataBind()
                End If

                'Asigno imagen de pie
                If My.Computer.FileSystem.FileExists("D:/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/pie_factura.png") = True Then
                    Image_pie.ImageUrl = "~/imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/pie_factura.png?" + numero_aleatorio.Next(100, 999999999).ToString()
                    Image_pie.DataBind()
                End If
    ...
    Protected Sub btn_subir_logo_Click(sender As Object, e As EventArgs) Handles btn_subir_logo.Click
        ...
        Try
            ...
            'Asigno 
            Dim nombre As String = "fondo_factura.png"
            Dim ruta_imagen As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/" & nombre & "?" + numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de Factura", "Ha cambiado la imagen del diseño de la factura.")
    ...
    Protected Sub btn_si_eliminar_Click(sender As Object, e As EventArgs) Handles btn_si_eliminar.Click
        ...
        Try
            ...
            'Asigno 
            Dim ruta_imagen_origen As String = Server.MapPath("..") & "\imagenes\factura\fondo_factura.png"
            Dim ruta_imagen_destino As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\fondo_factura.png"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/fondo_factura.png?" & numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de FActura", "Ha asignado la imagen por defecto.")
    ...
    Private Sub btn_subir_pie_Click(sender As Object, e As EventArgs) Handles btn_subir_pie.Click
        ...
        Try
            ...
            'Asigno 
            Dim nombre As String = "pie_factura.png"
            Dim ruta_imagen As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\"
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de Factura", "Ha cambiado la imagen del pie de la factura.")
    ...
    Protected Sub btn_si_eliminar_pie_Click(sender As Object, e As EventArgs) Handles btn_si_eliminar_pie.Click
        ...
        Try
            ...
            'Asigno 
            Dim ruta_imagen_origen As String = Server.MapPath("..") & "\imagenes\factura\pie_factura.png"
            Dim ruta_imagen_destino As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\factura\pie_factura.png"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/factura/pie_factura.png?" & numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de Factura", "Ha asignado la imagen del pie por defecto.")
