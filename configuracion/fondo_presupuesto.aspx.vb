...
Partial Class configuracion_fondo_presupuesto
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                'Compruebo si existe la carpeta presupuesto
                If Not System.IO.Directory.Exists("D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\") Then

                    'Creo el directorio
                    System.IO.Directory.CreateDirectory("D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\")

                    'Creo el pie del presupuesto
                    System.IO.File.Copy(Server.MapPath("..") & "\imagenes\presupuesto\fondo_presupuesto.png", "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\fondo_presupuesto.png", True)
                    System.IO.File.Copy(Server.MapPath("..") & "\imagenes\presupuesto\pie_presupuesto.png", "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\pie_presupuesto.png", True)
                ...
                If My.Computer.FileSystem.FileExists("D:/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/fondo_presupuesto.png") = True Then
                    Image_factura.ImageUrl = "~/imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/fondo_presupuesto.png?" + numero_aleatorio.Next(100, 999999999).ToString()
                    Image_factura.DataBind()
                End If

                'Asigno imagen de pie
                If My.Computer.FileSystem.FileExists("D:/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/pie_presupuesto.png") = True Then
                    Image_pie.ImageUrl = "~/imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/pie_presupuesto.png?" + numero_aleatorio.Next(100, 999999999).ToString()
                    Image_pie.DataBind()
                End If
    ...
    Protected Sub btn_subir_logo_Click(sender As Object, e As EventArgs) Handles btn_subir_logo.Click
        ...
        Try
            ...
            'Asigno 
            Dim nombre As String = "fondo_presupuesto.png"
            Dim ruta_imagen As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/" & nombre & "?" + numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño del Presupuesto", "Ha cambiado la imagen del diseño del presupuesto.")
    ...
    Protected Sub btn_si_eliminar_Click(sender As Object, e As EventArgs) Handles btn_si_eliminar.Click
        ...
        Try
            ...
            'Asigno 
            Dim ruta_imagen_origen As String = Server.MapPath("..") & "\imagenes\presupuesto\fondo_presupuesto.png"
            Dim ruta_imagen_destino As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\fondo_presupuesto.png"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/fondo_presupuesto.png?" & numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de Presupuesto", "Ha asignado la imagen por defecto.")
    ...
    Private Sub btn_subir_pie_Click(sender As Object, e As EventArgs) Handles btn_subir_pie.Click
        ...
        Try
            ...
            'Asigno 
            Dim nombre As String = "pie_presupuesto.png"
            Dim ruta_imagen As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\"
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño de Presupuesto", "Ha cambiado la imagen del pie del presupuesto.")
    ...
    Protected Sub btn_si_eliminar_pie_Click(sender As Object, e As EventArgs) Handles btn_si_eliminar_pie.Click
        ...
        Try
            ...
            'Asigno 
            Dim ruta_imagen_origen As String = Server.MapPath("..") & "\imagenes\presupuesto\pie_presupuesto.png"
            Dim ruta_imagen_destino As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\presupuesto\pie_presupuesto.png"
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/presupuesto/pie_presupuesto.png?" & numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Diseño del presupuesto", "Ha asignado la imagen del pie por defecto.")
