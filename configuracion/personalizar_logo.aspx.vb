...
Partial Class configuracion_personalizar_logo
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                'Ver Logo
                If My.Computer.FileSystem.FileExists("D:/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/logo/" & tabla_empresa.Rows(0)("logo")) = True Then
                    Image_logo.ImageUrl = "~/imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/logo/" & tabla_empresa.Rows(0)("logo") + "?" + numero_aleatorio.Next(100, 999999999).ToString()
                    Image_logo.DataBind()
                End If
    ...
    Protected Sub btn_subir_logo_Click(sender As Object, e As EventArgs) Handles btn_subir_logo.Click
        ...
        Try
            ...
            Dim ruta_imagen As String = "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\logo\"
            ...
            Dim alto_final As Integer = CInt(((CInt(bm_source.Height)) * 100) / ((CInt(bm_source.Width) * 100) / 125))

            'Convierto a la resolución y tamaño deseados
            Dim imagen As New Bitmap(bm_source, 125, alto_final)
            ...
            'Actualizo la imagen
            Dim numero_aleatorio As New Random
            Dim ruta_calculada As String = "imagenes_usuarios_facturacion/imagenes_usuarios_facturacion/" & tabla_empresa.Rows(0)("ruta_base_datos") & "/logo/" & tabla_empresa.Rows(0)("logo") + "?" + numero_aleatorio.Next(100, 999999999).ToString()
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Personalizar Logo", "Ha cambiado el Logo de la empresa.")

            'Registro como bloque en local para el jquery
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType, "Notificacion_ok", "ok('Logo actualizado correctamente.');", True)
    ...
    Protected Sub chk_tema_original_CheckedChanged(sender As Object, e As EventArgs) Handles chk_tema_original.CheckedChanged
        ...
        Try
            ...
            If chk_tema_original.Checked Then
                ...
                'Asigno
                lt_mensaje_eliminar.Text = "¿Esta seguro que desea aplicar el logo por defecto?"
                chk_tema_original.Checked = False
    ...
    Protected Sub btn_si_eliminar_Click(sender As Object, e As EventArgs) Handles btn_si_eliminar.Click
        ...
        Try
            ...
            'Copio Logo IO
            System.IO.File.Copy(Server.MapPath("..") & "\Imagenes\logo\" & tabla_empresa.Rows(0)("logo"), "D:\imagenes_usuarios_facturacion\" & tabla_empresa.Rows(0)("ruta_base_datos") & "\logo\" & tabla_empresa.Rows(0)("logo"), True)
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Personalizar Logo", "Ha asignado el logo por defecto.")
