...
Partial Class informes_facturas_emitidas
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                'Asigno
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType, "Asigno", "setTimeout(function () { $('#txt_fecha_inicial').focus();}, 100);", True)
    ...
    Protected Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        ...
        Try
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Informe Facturas Emitidas", "Solicitó listado.(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Private Sub img_descargar_Click(sender As Object, e As EventArgs) Handles img_descargar.Click
        ...
        Try
                ...
                Using zip As ZipFile = New ZipFile()
                    ...
                    For Each row As GridViewRow In gridview_consulta.Rows
                        ...
                        If chkSeleccionar IsNot Nothing AndAlso chkSeleccionar.Checked Then
                            ...
                            Dim nombre_fichero As String = crear_pdf_salida(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), n_factura)
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Informe Facturas Emitidas", "Descargó ZIP con Facturas.(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
        ...
        Catch ex As Exception
            'Registro Error
            funciones_globales.grabar_registro_error(tabla_empresa.Rows(0)("Id"), tabla_usuario.Rows(0)("Id"), Request.Url.Segments.Last(), "img_descargar_Click", ex.Message)
            'Registro como bloque en local para el jquery
