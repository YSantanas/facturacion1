...
Partial Class clientes_contactos
    ...
    Sub leer_sucursal(ByVal id_cliente As Integer)
        ...
        Try
            ...
            'Obtengo
            Dim tabla_consulta As DataTable = funciones_globales.obtener_datos("SELECT * FROM [" & tabla_empresa.Rows(0)("ruta_base_datos") & "].[dbo].[sucursales] WHERE id_cliente = " & id_cliente & " AND id<>0 ORDER BY Id")
    ...
    Protected Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        ...
        Try
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Contactos", "Solicitó listado de contactos del cliente: " & txt_cliente.Text & ".(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Sub cargar_GV()
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa.Rows(0)("ruta_base_datos"))
                ...
                If txt_cliente.Text = "" Then
                    memComando.CommandText = "SELECT contactos.*,clientes.nombre_fiscal " &
                    "FROM contactos INNER JOIN " &
                    "clientes ON contactos.id_cliente=clientes.id;"
                Else
                    ...
                    Else
                        ...
                        "FROM contactos INNER JOIN " &
                        "clientes ON contactos.id_cliente=clientes.id " &
                        "WHERE contactos.id_cliente=@id_cliente AND id_sucursal=@id_sucursal;"
                        memComando.Parameters.Add(New SqlParameter("id_cliente", Data.SqlDbType.Int))
                        memComando.Parameters("id_cliente").Value = txt_cliente.Text
    ...
    Private Sub gridview_consulta_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridview_consulta.RowCommand
        ...
        Try
            ...
            If (e.CommandName = "borrar") Then
                ...
                LT_mensaje.Text = "¿Está seguro de eliminar el Contacto: " & gridview_consulta.DataKeys(index).Item("nombre").ToString() & " " & gridview_consulta.DataKeys(index).Item("primer_apellido").ToString() & " " & gridview_consulta.DataKeys(index).Item("segundo_apellido").ToString() & " del Cliente: " & gridview_consulta.DataKeys(index).Item("nombre_fiscal").ToString() & " y Sucursal Nº: " & gridview_consulta.DataKeys(index).Item("id_sucursal").ToString() & "?"
            ...
            If (e.CommandName = "consultar") Then
                ...
                'Leer Sucursal
                leer_sucursal(txt_cliente_modal.Text)
                DDL_sucursal.SelectedIndex = DDL_sucursal.Items.IndexOf(DDL_sucursal.Items.FindByValue(gridview_consulta.DataKeys(index).Item("id_sucursal")))
    ...
    Protected Sub btn_eliminar_confirmar_Click(sender As Object, e As EventArgs) Handles btn_eliminar_confirmar.Click
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa.Rows(0)("ruta_base_datos"))
                ...
                memComando.CommandText = "DELETE FROM contactos WHERE id_cliente=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_cliente") & " AND id_sucursal=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_sucursal") & " AND cargo='" & gridview_consulta.DataKeys(txt_index.Text).Item("cargo") & "' AND nombre='" & gridview_consulta.DataKeys(txt_index.Text).Item("nombre") & "' AND primer_apellido='" & gridview_consulta.DataKeys(txt_index.Text).Item("primer_apellido") & "' AND segundo_apellido='" & gridview_consulta.DataKeys(txt_index.Text).Item("segundo_apellido") & "';"
                memComando.Connection = memConn
    ...
    Protected Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        Try
            ...
            Dim tabla_consulta As DataTable = funciones_globales.obtener_datos("SELECT TOP (1) id FROM " & tabla_empresa.Rows(0)("ruta_base_datos") & ".[dbo].[clientes] WHERE id=" & txt_cliente_modal.Text & ";")
            If tabla_consulta.Rows.Count = 0 Then
                'Registro como bloque en local para el jquery
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType, "Error_", funciones_globales.modal_register("setTimeout(function () { $('#txt_cliente_modal').focus();$('#txt_cliente_modal').select();}, 100);$('#modal_agregar').modal('show');error('El Código de Cliente no existe.')"), True)
                Exit Sub
            End If
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa(0)("ruta_base_datos"))
                ...
                'Agrego
                memComando.CommandText = "INSERT INTO contactos (id_cliente,id_sucursal,fecha_creacion,hora_creacion,cargo,nombre,primer_apellido,segundo_apellido,contacto,observaciones) VALUES " &
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Contactos", "Creó el Contacto: " & txt_nombre.Text & " " & txt_primer_apellido.Text & " " & txt_segundo_apellido.Text & " para el Cliente: " & lbl_txt_cliente_modal.Text & " y la Sucursal: " & DDL_sucursal.SelectedValue.ToString & ".(Tiempo:  " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Protected Sub btn_modificar_Click(sender As Object, e As EventArgs) Handles btn_modificar.Click
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa(0)("ruta_base_datos"))
                ...
                'Actualizo
                memComando.CommandText = "UPDATE contactos SET " &
                "cargo=@cargo, " &
                "nombre=@nombre, " &
                ...
                "WHERE id_cliente=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_cliente") & " AND id_sucursal=" & gridview_consulta.DataKeys(txt_index.Text).Item("id_sucursal") & " AND cargo='" & gridview_consulta.DataKeys(txt_index.Text).Item("cargo") & "' AND nombre='" & gridview_consulta.DataKeys(txt_index.Text).Item("nombre") & "' AND primer_apellido='" & gridview_consulta.DataKeys(txt_index.Text).Item("primer_apellido") & "' AND segundo_apellido='" & gridview_consulta.DataKeys(txt_index.Text).Item("segundo_apellido") & "';"
                memComando.Parameters.Add("@cargo", Data.SqlDbType.VarChar, 150).Value = txt_cargo.Text.ToUpper
                memComando.Parameters.Add("@nombre", Data.SqlDbType.VarChar, 150).Value = txt_nombre.Text.ToUpper
                memComando.Parameters.Add("@primer_apellido", Data.SqlDbType.VarChar, 150).Value = txt_primer_apellido.Text.ToUpper
                memComando.Parameters.Add("@segundo_apellido", Data.SqlDbType.VarChar, 150).Value = txt_segundo_apellido.Text.ToUpper
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Contactos", "Modificó el Contacto: " & txt_nombre.Text & " " & txt_primer_apellido.Text & " " & txt_segundo_apellido.Text & " para el Cliente: " & lbl_txt_cliente_modal.Text & " y la Sucursal: " & DDL_sucursal.SelectedValue.ToString & ".(Tiempo:  " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
