<%@ Page Language="VB" AutoEventWireup="false" CodeFile="contactos.aspx.vb" Inherits="clientes_contactos" %>
...
<head runat="server">
    ...
    <script src="../Scripts/js_clientes.js"></script>
    <script src="../Scripts/js_cargo.js"></script>
    ...
    $(document).ready(function () {
        ...
        $("#btn_consultar").on('click', function (e) {
            ...
            //Mensaje al usuario
            mostrar_trabajando('Consultando Contactos, por favor espere.');
        ...
        $("#btn_grabar").on('click', function () {
            ...
            if ($.trim($("#txt_cliente_modal").val()) == '') {
                error('El campo Cliente no puede estar vacío.')
            ...
            //Excepciones
            if ($.trim($("#txt_valor").val()) == '') {
                error('El Campo Teléfono, email, etc no puede estar vacío.')
                setTimeout(function () { $("#txt_valor").focus(); }, 100);
                return false;
            };

            //Mensaje al usuario
            $('#modal_agregar').modal('hide');
            mostrar_trabajando('Agregando contacto, por favor espere.');
        ...
        $("#btn_modificar").on('click', function () {
            ...
            //Mensaje al usuario
            $('#modal_agregar').modal('hide');
            mostrar_trabajando('Modificando Contacto, por favor espere.');
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Alta de Contactos de Clientes</h5>
        ...
        <div class="panel-container">
            ...
            <div class="panel-left">
                ...
                <asp:TextBox ID="txt_cliente" runat="server" class="form-control textbox_cliente" placeholder="Código, Nombre o *NIF" AutoPostBack="true"></asp:TextBox>
                ...
                <asp:TextBox ID="txt_sucursal" runat="server" class="form-control" placeholder="Número de la Sucursal" AutoPostBack="true"></asp:TextBox>
                <div class="text-primary" style="position:absolute; top:35px;font-size: 12px;height:20px;">
                    <asp:Label ID="lbl_txt_sucursal" runat="server" Text=""></asp:Label>
                </div>
                </div>
                <br />
            ...
            <div class="container-fluid" style="text-align:center">
                ...
                <tr>
                    <td style="width:50%;border: 0px solid blue; text-align:left;">
                        ...
                        <asp:LinkButton ID="img_exportar_txt" runat="server" CssClass ="bi bi-filetype-txt text-primary"  Font-Size="20" height="25" ToolTip="Descargar Excel" TabIndex ="-1" Visible="false"></asp:LinkButton>
                    </td>
                ...
                cssclass="table table-condensed" Font-Size="11px" Width="100%" ToolTip="Consulta de Sucursales" EmptyDataText="No hay resultados."
                CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="id_cliente,id_sucursal,fecha_creacion,hora_creacion,cargo,nombre,primer_apellido,segundo_apellido,contacto,observaciones,nombre_fiscal" 
                ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="25">
                <AlternatingRowStyle BackColor="White" />
            
                <Columns>

                    <asp:BoundField DataField="nombre_fiscal" HeaderText="Cliente"
                        SortExpression="nombre_fiscal" ReadOnly="True">
                    <HeaderStyle CssClass="gvHeaderleft"/>
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>

                    <asp:BoundField DataField="id_sucursal" HeaderText="Código Sucursal" HeaderStyle-Width="90"
                        SortExpression="id_sucursal" ReadOnly="True">
                    <HeaderStyle CssClass="gvHeaderleft"/>
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    
                    <asp:BoundField DataField="" HeaderText="Contacto"
                        SortExpression="" ReadOnly="True" ItemStyle-HorizontalAlign="left">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>

                    <asp:BoundField DataField="contacto" HeaderText=""
                    SortExpression="contacto" ReadOnly="True" ItemStyle-HorizontalAlign="left">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
        ...
        <div class="modal-dialog">
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Eliminar Contacto</h1>
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_cliente_modal" runat="server" class="form-control textbox_cliente" placeholder="Escriba un Código de Cliente, Nombre o *NIF"  maxlength="15" AutoPostBack="True"></asp:TextBox>
                        <div class="text-primary" style="position:absolute; top:35px;font-size: 12px;height:20px;">
                            <asp:Label ID="lbl_txt_cliente_modal" runat="server" Text=""></asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                         ...
                         <asp:DropDownList ID="DDL_sucursal" runat="server" class="form-control"></asp:DropDownList>
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_cargo" runat="server" class="form-control textbox_cargo" placeholder="Escriba cargo en la Empresa"  maxlength="200"></asp:TextBox>
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3">
                         ...
                         <asp:TextBox ID="txt_nombre" runat="server" class="form-control" placeholder="Nombre" maxlength="70"></asp:TextBox>
                     </div>
                     ...
                     <div class="input-group input-group-sm mb-3">
                         ...
                         <asp:TextBox ID="txt_primer_apellido" runat="server" class="form-control" placeholder="1º Apellido" maxlength="200"></asp:TextBox>
                     </div>
                      ...
                      <div class="input-group input-group-sm mb-3">
                         ...
                         <asp:TextBox ID="txt_segundo_apellido" runat="server" class="form-control" placeholder="2º Apellido" maxlength="200"></asp:TextBox>
                     </div>

                     <div class="input-group input-group-sm mb-3">
                         <div class="input-group-prepend">
                             <span class="input-group-text">
                                Tlf, Email,Facebook, etc:
                             </span>
                         </div>
                         <asp:TextBox ID="txt_valor" runat="server" class="form-control" placeholder="Teléfonos, Email, Red Social, etc" maxlength="50"></asp:TextBox>
                     </div>
