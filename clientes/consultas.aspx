<%@ Page Language="VB" AutoEventWireup="false" CodeFile="consultas.aspx.vb" Inherits="clientes_consultas" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <table style="width: 100%">
            <tr>
                <td width="70" align="center"><small>Cod.Cliente</small></td>
            ...
            <tr>
                <td align="right"><asp:TextBox ID="txt_cod_cliente" runat="server" CssClass="form-control input-sm textbox_cod_cliente" MaxLength="7" width="95%" Style="text-transform: uppercase"></asp:TextBox></td>
                <td align="center"><asp:TextBox ID="txt_nombre" runat="server" class="form-control input-sm textbox_denominacion_cliente"  MaxLength="200" width="95%" Style="text-transform: uppercase"></asp:TextBox> </td>
        ...
        <div id="ver" style="position:fixed;top:0px;background-color:#cce5ff;color:#333333;font-weight:700; width:100%;display:none;">
            ...
            <ItemTemplate>
                ...
                <asp:LinkButton ID ="lk_cliente" runat ="server" 
                    CssClass ="bi bi-person-lines-fill text-primary" 
                    Font-Size="25px"
                    ToolTip ="Ir a Clientes" TabIndex="-1" 
            ...
            <ItemTemplate>
                 <asp:LinkButton ID ="lk_sucursal" runat ="server" visible="false" 
                     CssClass ="bi bi-file-earmark-break text-primary" 
                     Font-Size="25px"
            ...
            <ItemTemplate>
                 <asp:LinkButton ID ="lk_contacto" runat ="server" visible="false" 
                     CssClass ="bi bi-columns text-primary" 
                     Font-Size="25px"
