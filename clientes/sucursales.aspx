<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sucursales.aspx.vb" Inherits="clientes_sucursales" %>
...
<head runat="server">
    ...
    $(document).ready(function () {
        ...
        $("#btn_consultar").on('click', function (e) {
            ...
            //Mensaje al usuario
            mostrar_trabajando('Consultando Sucursales, por favor espere.');
        ...
        $("#btn_grabar").on('click', function () {
            ...
            if ($.trim($("#txt_sucursal_modal").val()) == '') {
                error('El campo sucursal no puede estar vacío.')
                setTimeout(function () { $("#txt_sucursal_modal").focus(); }, 100);
                return false;
            } 
            ...
            mostrar_trabajando('Agregando sucursal, por favor espere.');
        ...
        $("#btn_modificar").on('click', function () {
            ...
            //Mensaje al usuario
            $('#modal_agregar').modal('hide');
            mostrar_trabajando('Modificando sucursal, por favor espere.');
        ...
        $("#abrir_contactos").on('click', function (e) {
            ...
            $('#icontactos', window.parent.document).attr('src', $('#icontactos', window.parent.document).attr('src')); window.parent.abrir_ventana_relacional('contactos', 'bi-columns', '1000', '600', 'clientes/contactos.aspx|id_cliente=' + $('#txt_cliente_modal').val() + '&id_sucursal=' + $('#txt_sucursal_modal').val(), '1');
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Alta de Sucursales de Clientes</h5>
        ...
        <div class="panel-container">
            ...
            <div class="container-fluid" style="text-align:center">
                ...
                CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="id,id_cliente,fecha_creacion,hora_creacion,activo,denominacion,tipo_via,calle,numero,escalera,piso,puerta,cp,pais,provincia,localidad,observaciones,nombre_fiscal,nombre_tipo_via" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="id" HeaderText="Código Sucursal" HeaderStyle-Width="90"
                    ...
                    <asp:BoundField DataField="" HeaderText="Dirección"
        ...
        <div class="modal-dialog">
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Eliminar Sucursal</h1>
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_sucursal_modal" runat="server" class="form-control" placeholder="Escriba un Código de Sucursal"  maxlength="15"></asp:TextBox>
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_denominacion" runat="server" class="form-control" placeholder="Escriba una denominación"  maxlength="200"></asp:TextBox>
                    </div>
