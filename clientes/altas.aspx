<%@ Page Language="VB" AutoEventWireup="false" CodeFile="altas.aspx.vb" Inherits="clientes_altas" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#btn_consultar").on('click', function (e) {
                ...
                //Mensaje al usuario
                mostrar_trabajando('Consultando Clientes, por favor espere.');
            ...
            $("#btn_grabar").on('click', function () {
                ...
                mostrar_trabajando('Agregando cliente, por favor espere.');
            ...
            $("#btn_modificar").on('click', function () {
                ...
                //Mensaje al usuario
                $('#modal_agregar').modal('hide');
                mostrar_trabajando('Modificando cliente, por favor espere.');
            ...
            $("#abrir_contactos").on('click', function (e) {
                ...
                $('#icontactos', window.parent.document).attr('src', $('#icontactos', window.parent.document).attr('src')); window.parent.abrir_ventana_relacional('contactos', 'bi-columns', '1000', '600', 'clientes/contactos.aspx|id_cliente=' + $('#txt_cliente_modal').val() + '&id_sucursal=0', '1');
            ...
            $("#abrir_sucursales").on('click', function (e) {
                ...
                //Abro Sucursales enviando el codigo de cliente
                $('#isucursales', window.parent.document).attr('src', $('#isucursales', window.parent.document).attr('src')); window.parent.abrir_ventana_relacional('sucursales', 'bi-file-earmark-break', '1000', '600', 'clientes/sucursales.aspx|id_cliente=' + $('#txt_cliente_modal').val(),'1');
...
<body>
    <form id="form1" runat="server">
        ...
        <h5><span id="recoger" class="bi bi-arrow-left-right text-primary" style="font-size:16px;" onmouseover="hand('recoger')" title="Contraer/Expandir menú"></span> Alta de Clientes</h5>
	        ...
	        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <asp:TextBox ID="txt_cliente_modal" runat="server" class="form-control textbox_cliente" placeholder="Escriba un Código de Cliente"  maxlength="15"></asp:TextBox>
                        <div class="text-primary" style="position:absolute; top:35px;font-size: 12px;height:20px;">
