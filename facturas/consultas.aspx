<%@ Page Language="VB" AutoEventWireup="false" CodeFile="consultas.aspx.vb" Inherits="facturas_consultas" %>
       ...
       <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div id="ver" style="position:fixed;top:0px;background-color:#cce5ff;color:#333333;font-weight:700; width:100%;display:none;">
            ...
            <tr>                 
                ...
                <td width="100" align="center"><small>N.I.F.</small></td>
                <td width="250" align="center"><small>Nº Factura</small></td>
                <td width="70" align="center"><small>Total</small></td>
                <td width="50" align="center"><small>Linea</small></td>                                       
            ...
            CellPadding="4" ForeColor="#333333" GridLines="Both" DataKeyNames="n_factura,fecha_creacion,hora_creacion,fecha,cod_cliente,cliente,nif,total,linea,cod_articulo,denominacion" 
