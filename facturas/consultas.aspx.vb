...
Partial Class facturas_consultas
    ...
    Protected Sub btn_consultar_Click(sender As Object, e As EventArgs) Handles btn_consultar.Click
        ...
        Try
            ...
            'Limpio el trazador
            funciones_globales.grabar_registro(tabla_empresa.Rows(0)("ruta_base_datos"), tabla_usuario.Rows(0)("Id"), tabla_usuario.Rows(0)("nombre") & " " & tabla_usuario.Rows(0)("primer_apellido") & " " & tabla_usuario.Rows(0)("segundo_apellido"), "Consultas de Facturas", "Solicitó listado.(Tiempo: " & tspan.ToString("hh\:mm\:ss\:ff") & ").")
    ...
    Sub cargar_GV()
        ...
        Try
            ...
            Using memConn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString & ";Initial Catalog=" & tabla_empresa.Rows(0)("ruta_base_datos"))
                ...
                'Compongo la SELECT
                query = "SELECT cabecera_facturas.n_factura,cabecera_facturas.fecha_creacion,cabecera_facturas.hora_creacion,cabecera_facturas.fecha,cabecera_facturas.cod_cliente,cabecera_facturas.cliente,cabecera_facturas.nif,cabecera_facturas.total " &
                        ",detalles_facturas.linea ,detalles_facturas.cod_articulo,detalles_facturas.denominacion FROM cabecera_facturas,detalles_facturas "
                filtro = "WHERE cabecera_facturas.n_factura=detalles_facturas.n_factura "
                orden = "ORDER BY cabecera_facturas.n_factura,detalles_facturas.linea;"
